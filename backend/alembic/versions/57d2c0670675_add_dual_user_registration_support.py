...
def upgrade() -> None:
    ...
    if table_exists('users') and not column_exists('users', 'verification_status'):
    ...
    if table_exists('users') and not index_exists('users', 'idx_users_role'):
        op.create_index('idx_users_role', 'users', ['role'])
    
    if table_exists('users') and not index_exists('users', 'idx_users_verification_status'):
        op.create_index('idx_users_verification_status', 'users', ['verification_status'])
    
    if table_exists('gurus') and not index_exists('gurus', 'idx_gurus_user_id'):
        op.create_index('idx_gurus_user_id', 'gurus', ['user_id'])
    
    if table_exists('gurus') and not index_exists('gurus', 'idx_gurus_verified_by'):
...
def downgrade() -> None:
    ...
    if table_exists('users') and column_exists('users', 'verification_status'):
